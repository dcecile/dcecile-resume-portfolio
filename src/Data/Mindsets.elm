    ...
    let
        making =
            MindsetsItemData
                ...
                [ markedString "At `Unitron`, I made manufacturing software in `C#`—by listening for details hidden behind rough wishes, then building solutions to fit the needs and the context"
